...
public class Main_Menu_Controller {
    ...
    public void handleAboutButton(ActionEvent actionEvent) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        openPopup("About Us", "We are a team of highly enthusiastic three individuals who wanted to start an event management company. We deal in all kinds of events and try to provide the best services possible.\n" +
